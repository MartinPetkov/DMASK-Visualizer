...
from pyparsing import CaselessKeyword, Optional, nums, alphanums
from pyparsing import QuotedString, SkipTo, LineEnd, restOfLine, cStyleComment
...
statement.ignore(line_comment)
statement.ignore(block_comment)
