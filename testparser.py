...
class TestSQL(unittest.TestCase):
    ...
    def test_24_in_subquery(self):
        ...
        output = ast('select sid, dept || cnum as course, grade from Took natural join Offering where grade >= 80 and cnum in (select cnum from Took natural join offering natural join Student where surname = \'Lakemeyer\');')
        print(expected)
        print(output)
